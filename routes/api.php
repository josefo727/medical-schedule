...
use App\Http\Controllers\Api\Patient\AppointmentScheduledController;
...
Route::name('api.patient.')
    ->group(function (){
        ...
        Route::get('/appointment-scheduled/{documentNro}', [AppointmentScheduledController::class, 'index']);
    });
