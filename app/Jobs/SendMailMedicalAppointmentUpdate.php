...
use App\Mail\UpdateRegisterMedicalAppointment;
...
class SendMailMedicalAppointmentUpdate implements ShouldQueue
{
    ...
    {
        Mail::to($this->emails)->send(new UpdateRegisterMedicalAppointment($this->medicalAppointment));
    }
}
